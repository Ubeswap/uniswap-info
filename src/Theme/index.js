...
const theme = (darkMode, color) => ({
  ...
  ubeswapPink: darkMode ? '#8878c3' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#788dc3' : '#8878c3',
  primary2: darkMode ? '#4e69b0' : '#634eb0',
  primary3: darkMode ? '#7187c0' : '#8271c0',
  primary4: darkMode ? '#376bad70' : '#F6DDE8',
  primary5: darkMode ? '#153d6f70' : '#FDEAF1',

  // color text
  primaryText1: darkMode ? '#788dc3' : '#8878c3',

  // secondary colors
  secondary1: darkMode ? '#788dc3' : '#8878c3',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #8878c330 0%, #fff 0%)`,
})
